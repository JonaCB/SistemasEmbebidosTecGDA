...
uint8_t config_msb = 0b11000010;//0b11000100;     ///<Start a single conversion (when in power-down state). AINP = AIN0 and AINN = GND, FSR = ±4.096 V, Continuous-conversion mode.
uint8_t config_lsb = 0b10000011;                  ///<128 SPS, Disable comparator and set ALERT/RDY pin to high-impedance.
