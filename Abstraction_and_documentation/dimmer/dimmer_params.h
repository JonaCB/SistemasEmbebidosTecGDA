...
#include "../system_common/system_common.h"           ///<Common system macros and functions.

#define PWM_PRESCALER          1                      ///<PWM prescaler constant define
#define PWM_PIN_PORT_CLOCK     RCC_GPIOA              ///<Port clock address for the PWM define
#define PWM_PIN_PORT           GPIOA                  ///<GPIO module address for the PWM define
#define PWM_PIN                GPIO1                  ///<PIN for the PWM define
#define PWM_TIMER_CLOCK        RCC_TIM2               ///<Timer clock address for the PWM module
#define PWM_TIMER              TIM2                   ///<Timer address for the PWM module
#define PWM_TIMER_CHANNEL      TIM_OC2                ///<Timer output compare channel address
